...
public class citasReactivaResource {
    ...
    private Flux<citasDTOReactiva>consultarFechayHora(@RequestParam("fecha")String fecha,@RequestParam("hora") String horaReserva)
    {
        //LocalDate fechaReserva = LocalDate.parse(fecha);
        return  icitasReactivaService.consultarFechaYHora(fecha,horaReserva);
    }
    ...
    private  Mono<String>consultarMedico(@PathVariable("id") String id)
    {
        return icitasReactivaService.consultarMedico(id);
    }


    @GetMapping("citasReactivas/padecimientos/{idPaciente}")
